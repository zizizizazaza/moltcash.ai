...
async function seed() {
  ...
  const projects = [
    ...
    },
    {
      ...
      subtitle: 'E-commerce Revenue Pool',
      category: 'E-commerce',
      issuer: 'MerchantDAO',
      faceValue: 100,
      askPrice: 99,
      ...
      remainingCap: 115000,
      coverageRatio: 1.3,
      verifiedSource: 'Shopify Analytics',
      description: 'Pooled revenue stream from verified Shopify merchants with consistent sales history.',
      useOfFunds: 'Inventory financing, marketing spend, working capital',
      coverImage: '',
      issuerLogo: '',
    },
    {
      title: 'AWS Infrastructure Note',
      subtitle: 'Cloud Usage Revenue',
      category: 'SaaS',
      issuer: 'CloudBridge',
      faceValue: 100,
      askPrice: 98,
      ...
      remainingCap: 410000,
      coverageRatio: 1.4,
      verifiedSource: 'AWS Billing',
      description: 'Revenue-backed note from enterprise AWS infrastructure reseller with long-term contracts.',
      useOfFunds: 'Reserved instance purchases, infrastructure scaling',
      coverImage: '',
      issuerLogo: '',
    },
  ];
